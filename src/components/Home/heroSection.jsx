const HeroSection = (props = {}) => {
  return (
    <section className={`${props.className} w-full text-lightColor flex flex-col gap-7`}>
      <p className="text-themeColor/90 font-themeFont xs:text-xs 2xl:text-2xl">Hi, my name is </p>
      <section className="">
      ...
      <section className="bg-themeColor mt-8 rounded-md w-max">
        <button className="border w-fit px-7 py-5 bg-bg-grad border-themeColor text-themeColor/90 rounded-md font-themeFont text-xs 2xl:text-2xl transition duration-300 hover:-translate-x-1 hover:-translate-y-1 ease-in-out">Check out my course !</button>
      </section>
    </section>
  );
}
