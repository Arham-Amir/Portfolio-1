      ...
      <section className={`${props.className} w-fit text-lightColor flex flex-col gap-7 xs:pb-24 smd:pb-0`}>
        ...
        <motion.li
          ...
          <section className="bg-themeColor mt-8 rounded-md w-max">
            <Link target="_blank" href="/Arham Amir.pdf" locale={false} className="border w-fit px-7 py-4 bg-bg-grad border-themeColor text-themeColor/90 rounded-md font-themeFont text-sm 2xl:text-2xl transition duration-300 hover:-translate-x-1 hover:-translate-y-1 ease-in-out">Resume</Link>
          </section>
        </motion.li>
      </section>
    </section>
