  ...
  return (
    <>
      ...
      <a href={userInfo['github']} target='blank' className={`${props.className} text-white w-full text-center opacity-60 hover:opacity-100 hover:text-themeColor flex flex-col gap-2 my-7`}>
        <p className="font-themeFont text-xs 2xl:text-base xs:tracking-normal md:tracking-widest">Designed & Built by Brittany Chiang</p>
        <section className="font-themeFont text-xs 2xl:text-base flex flex-row justify-center items-center gap-2">
          <BiStar size={15} />
          <p>6,529</p>
          &nbsp;
          <BiGitBranch size={16} />
