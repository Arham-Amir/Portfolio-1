...
function Card(props = {}) {
  ...
  return (
    <a href={props.el['link']} target='blank' className="bg-bg-light rounded-md w-full h-full p-7 flex flex-col gap-7 transition-all duration-300 ease-in-out hover:-translate-y-2">
