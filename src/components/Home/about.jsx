  ...
  return (
    <section className={`h-auto xl:mt-32 xs:mt-20 w-full transition-all duration-150`}>
      <article className="h-full transition-all duration-150 xl:w-[90%] mx-auto flex flex-col xl:p-7">
        <section className="cursor-pointer flex items-center flex-row gap-3 font-bold transition-all duration-150 xs:w-full md:w-[58%]">
          <p className="text-themeColor text-opacity-90 text-2xl">01.</p>
          <p className="text-lightColor hover:text-themeColor text-opacity-90 text-3xl ">
            About Me</p>
          <span className="bg-darkColor h-[1px] flex-1"></span>
        </section>
        <section className='flex mt-10 transition-all duration-150 md:flex-row xs:flex-col xs:items-center md:items-start'>
...
const AboutLeft = (props = {}) => {
  return (
    <section className={`${props.className} flex flex-col text-lightColor gap-10`}>
      <section className="flex flex-col gap-3 text-darkColor">
      ...
      <section className='flex flex-row gap-16'>
        <section className='flex flex-col gap-2 text-darkColor'>
